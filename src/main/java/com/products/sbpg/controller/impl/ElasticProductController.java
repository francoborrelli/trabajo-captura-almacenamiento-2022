...
/**
 * Esta clase presenta los diferentes "endpoints" de la api rest para gestionar productos utilizando el cliente de ElasticSearch
 * 
...
public class ElasticProductController implements IProductController {
    // for logging
